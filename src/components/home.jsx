        ...
        <div className="hidden md:block">
          <form className='md:h-[432px]  md:w-[410px] md:absolute md:top-[40px] md:left-[930px] md:gap-[32px] ' action="">
            ...
            <div className="md:absolute md:top-[66px]  md:h-[96px] md:w-[410px]" >
                <button className="md:flex justify-between md:w-[410px] md:h-[40px] md:rounded-lg md:pt-[12px] md:pb-[12px] md:pr-[128px] md:pl-[24px] md:text-[14px] md:leading-[16px] mt-4" style={{border:'1px solid #8064A2', borderRadius:'8px',fontWeight:'600'}}> <img src="public/assets/images/go.png" alt="" />Continue with Google</button>
                <button className="md:flex justify-between md:w-[410px] md:h-[40px] md:rounded-lg md:pt-[12px] md:pb-[12px] md:pr-[128px] md:pl-[24px] md:text-[14px] md:leading-[16px] mt-3" style={{border:'1px solid #8064A2', borderRadius:'8px',fontWeight:'600'}}><img src="public/assets/images/fb.png" alt=""   />Continue with Facebook</button>
            </div>
...
<div className="md:absolute md:top-[66px]  md:h-[96px] md:w-[410px]" >
                <button className="flex justify-between w-[312px] h-[32px] rounded-lg pt-[7px] pb-[5px] pr-[100px] pl-[24px] text-[12px] leading-[16px] mt-4" style={{border:'1px solid #8064A2', borderRadius:'8px',fontWeight:'600'}}> <img src="public/assets/images/go.png" alt="" />Continue with Google</button>


                <button className="flex justify-between w-[312px] h-[32px] rounded-lg pt-[7px] pb-[5px] pr-[100px] pl-[24px] text-[12px] leading-[16px] mt-2" style={{border:'1px solid #8064A2', borderRadius:'8px',fontWeight:'600'}}><img src="public/assets/images/fb.png" alt=""   />Continue with Facebook</button>
            </div>
