  ...
  return (
    <div className=' h-[708px] w-[360px] relative top-[2132px] md:h-[672px] md:w-[100%] md:relative md:top-[1200px] bg-white '>
        ...
        <div className='flex justify-center items-center md:absolute md:top-[40px] md:left-[40px] absolute  top-[24px] left-[77px]  '>
          <img src="src/assets/images/quote.png" alt="" className='h-[32px] w-[32px] mr-1 md:h-[40px] md:w-[40px] md:mr-[24px]'/>
...
<img src="src/assets/images/cover.png" alt="" className='h-[40px] w-[40px] absolute top-[12px] left-[208px] md:h-14 md:w-14 md:absolute md:top-[19px] md:left-[650px]'/>

        </div>
        <img src="src/assets/images/gp.png" alt="" className='h-[60px] w-[236px] absolute top-[432px] left-[38px] md:absolute md:top-[332px] md:left-[896px] md:h-[100px] md:w-[304px]' />
