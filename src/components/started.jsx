...
const Started = () => {
  return (
    <div className='h-[267px] w-[360px] relative top-[1965px] md:h-[662px] md:w-[1440px] bg-[#F7FDFF] md:relative md:top-[1153px]'>
        ...
        <div>
            <img src="public/assets/images/group2.png" alt="" className='h-[76px] w-[312.05px] absolute top-[175px] left-[24px] md:h-[302px] md:w-[1240px] md:absolute md:top-[330px] md:left-[100px]' />
        </div>
    </div>
  )
}
